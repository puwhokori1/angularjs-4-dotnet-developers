...
namespace LegacyDotNet
{
	public partial class Registration : System.Web.UI.Page
	{
		...
		{
			return new User {Id = 4, Name = "Joe Eames"};
		}
		...
		[WebMethod]
		public static void SetCourseRegistration(int courseId, bool registered)
		{
			Data.CourseList.Single(c => c.Id == courseId).Registered = registered;
		}
	}
